...
class RemoteChatAgentClient:
    ...
    async def start_alerts_analysis(
        ...
        return await self._make_request(
            "POST",
            "/acciones/analisis_alertas/start",
            json=payload,
            headers=headers,
            timeout=10.0,
        )
    ...
    async def get_alerts_analysis_status(
        ...
        """
        Obtiene el estado del análisis de alertas.
        """
        return await self._make_request(
            "GET",
            f"/acciones/analisis_alertas/status/{task_id}",
            timeout=10.0,
        )
    
    async def start_future_projections(
        self,
        user_id: str,
        auth_token: Optional[str] = None,
        model_preference: Optional[str] = None,
        ...
        return await self._make_request(
            "POST",
            "/acciones/proyecciones_futuras/start",
            json=payload,
            headers=headers,
            timeout=10.0,
        )
    
    async def get_future_projections_status(
        self,
        task_id: str
    ) -> Dict[str, Any]:
        """
        Obtiene el estado del análisis de proyecciones futuras.
        """
        return await self._make_request(
            "GET",
    ...
    async def start_daily_weekly_summary(
        self,
        user_id: str,
        auth_token: Optional[str] = None,
        model_preference: Optional[str] = None,
        ...
        return await self._make_request(
            "POST",
            "/acciones/resumen_diario_semanal/start",
            json=payload,
            headers=headers,
            timeout=10.0,
        )
    
    async def get_daily_weekly_summary_status(
        self,
        task_id: str
    ) -> Dict[str, Any]:
        """
        Obtiene el estado del resumen diario/semanal.
        """
        return await self._make_request(
            "GET",
            f"/acciones/resumen_diario_semanal/status/{task_id}",
            timeout=10.0,
        )
